...
func getUserChoice(UserChoice: String) -> String {
...
print(getUserChoice(UserChoice: Rock))
/*:
 ...
 */
func determineWinner(userChoice: String, _compChoice: String) -> String{
